...
<body>
	...
	<label id="lblAmount">            Balance Amount: 	 ${balanceAmount} </label>
		<div id="successHeader"><strong>Debit Transaction History </strong> </div>
	...
	<div id="successHeader"><strong>Credit Transaction History </strong> </div>
		<div class="table-align">
		<div class="table-align">
		<table>
			<caption>
				<caption>
					...
					<tr>
						<c:forEach var="tranactionDetails1" items="${tranactionDetails1}">
							<tr>
