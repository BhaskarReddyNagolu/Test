...
<body>
 <div class="topnav">
		...
		<div id="successHeader"><strong>Cash Transfer </strong> </div>
       <div id="successHeader">
             
              <strong>Logged in successful for the user - ${loggedInUserId}
    ...
    <div class="center-square">
              ...
              <form action=${pageContext.request.contextPath}/cash/transfer method="POST">
                     <div style="text-align: center;">
                           
                           
                           <label for="accountNumber">
                           <strong style="margin: 0px 0px 10px 0px;"> Account : </strong></label>&nbsp;&nbsp;
                           ${accountNo}<br /> <br /> 
                           ...
                           <label for="lbltransferType">
                           <strong style="margin: 0px 0px 10px 0px;"> Transfer Type : </strong></label>&nbsp;&nbsp;
